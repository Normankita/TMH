...
<img src="../web/images/night.jpg" alt="" style="width:100px; height:100px;">
    ...
    <div class="row">
        <div class="col-lg-4 mb-3">
            ...
            <p>As The Martin Houses, we offer one service as our major with few among to offer our customers with better and quality 
        ...
        <div class="col-lg-4 mb-3">
            ...
            <p><a class="btn btn-outline-secondary" href="#">Check Apartments &raquo;</a></p>
        </div>
        <div class="col-lg-4">
            <h2>As our customer</h2>

            <p>
                as our customer we assure you of our quality services, and well established environments to handle all case scenarios. you are warmely welcomed to the Martin's houses Dodoma
            </p>
